...
import { ChevronUp, FileCheck } from "lucide-react";
    ...
    <div className="h-full flex flex-col">
      <div className="flex mb-[15px] items-center gap-[15px]">
        ...
        <div className="flex font-bold text-[33px] items-baseline">
          <p className="flex items-center">PQRS anulados </p>
          {showRealCount ? (
      ...
      >
        ...
        {!initialLoading && sinResultados && (
          <div className="flex h-full w-full items-center justify-center">
            <NoMoreResults
              message="No hay a PQRs anulados"
              subtitle="No se encontraron PQRs en estado anulado."
              showAnimation={true}
            />
          </div>
        )}
