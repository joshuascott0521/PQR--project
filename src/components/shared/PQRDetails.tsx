    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div
            className={`px-4 py-2 rounded-full border ${pqr.estadoActual.color}`}
          >
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium">
              {formatDate(pqr.fechaVencimiento)}
            </span>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div
                    className={`inline-block px-3 py-1 rounded-full border text-sm font-medium mt-1 ${getTipoColor(
                      pqr.tipo
                    )}`}
                  >
                    {pqr.tipo}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formatDate(pqr.fechaRadicacion)}
                  </p>
                </div>
              </div>
            </div>
